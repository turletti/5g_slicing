...
class SMSFNon3GPPAccessRegistrationInfoRetrievalApi {
 ...
 private:
  ...
  void get_non3_gpp_smsf_registration_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
  void smsf_non3_gpp_access_registration_info_retrieval_api_default_handler(
      const Pistache::Rest::Request& request,
      Pistache::Http::ResponseWriter response);
  ...
  /// &quot;&quot;)</param>
  virtual void get_non3_gpp_smsf_registration(
