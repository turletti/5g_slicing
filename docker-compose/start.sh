...
echo "ping EXT-DN from UEs"
docker exec rfsim5g-oai-nr-ue1 ping -I oaitun_ue1 -c 1 192.168.70.145
docker exec rfsim5g-oai-nr-ue2 ping -I oaitun_ue1 -c 1 192.168.70.145
docker exec rfsim5g-oai-nr-ue3 ping -I oaitun_ue1 -c 1 192.168.70.145
docker exec rfsim5g-oai-nr-ue4 ping -I oaitun_ue1 -c 1 192.168.70.145
