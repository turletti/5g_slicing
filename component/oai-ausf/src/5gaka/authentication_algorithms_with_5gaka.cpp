...
void Authentication_5gaka::ComputeOPc(
  ...
  output_wrapper::print_buffer("ausf_app", "ComputeOPc kP   : ", kP, 16);

  RijndaelEncrypt(opP, opcP);

  output_wrapper::print_buffer("ausf_app", "ComputeOPc opP   : ", opP, 16);
  output_wrapper::print_buffer("ausf_app", "ComputeOPc opcP   : ", opcP, 16);
...
void Authentication_5gaka::derive_kseaf(
  ...
  output_wrapper::print_buffer("ausf_app", "derive_kseaf Kausf", kausf, 32);
  kdf(kausf, 32, S, 3 + netName.size, kseaf, 32);
  output_wrapper::print_buffer("ausf_app", "derive_kseaf Kseaf", kseaf, 32);
}
...
void Authentication_5gaka::derive_kausf(
  ...
  output_wrapper::print_buffer("ausf_app", "derive_kausf key", key, 32);
  kdf(key, 32, S, 11 + netName.size, kausf, 32);
  output_wrapper::print_buffer("ausf_app", "derive_kausf kausf", kausf, 32);
}
...
void Authentication_5gaka::derive_kamf(
  ...
  output_wrapper::print_buffer("ausf_app", "derive_kamf kseaf", kseaf, 32);
  kdf(kseaf, 32, S, 7 + supiLen, kamf, 32);
  output_wrapper::print_buffer("ausf_app", "derive_kamf kamf", kamf, 32);
}
...
void Authentication_5gaka::derive_knas(
  ...
  output_wrapper::print_buffer("ausf_app", "derive_knas kamf", kamf, 32);
  kdf(kamf, 32, S, 7, out, 32);
  // memcpy (knas, &out[31 - 16 + 1], 16);
  for (int i = 0; i < 16; i++) knas[i] = out[16 + i];
  output_wrapper::print_buffer("ausf_app", "derive_knas knas", knas, 16);
...
void Authentication_5gaka::derive_kgnb(
  ...
  *(uint32_t*) (S + 1) = htonl(uplinkCount);
  ...
  output_wrapper::print_buffer("ausf_app", "derive_kgnb kamf", kamf, 32);
  kdf(kamf, 32, S, 10, kgnb, 32);
  output_wrapper::print_buffer("ausf_app", "derive_kgnb kgnb", kgnb, 32);
}
...
int Authentication_5gaka::generate_vector(
  ...
  output_wrapper::print_buffer("ausf_app", "generate_vector MAC_A", mac_a, 8);
  ...
  output_wrapper::print_buffer("ausf_app", "generate_vector AK      : ", ak, 6);
  output_wrapper::print_buffer(
...
uint8_t* Authentication_5gaka::sqn_ms_derive(
  ...
  output_wrapper::print_buffer("ausf_app", "sqn_ms_derive() AK     : ", ak, 6);
  output_wrapper::print_buffer(
  ...
  output_wrapper::print_buffer("ausf_app", "MAC_S +: ", mac_s_computed, 8);
